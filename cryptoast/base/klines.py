...
class KLMngr(Klines):
  ...
  def from_quotes_or_assets(self, quotes_or_assets):
    ...
    klines = [Kline(asset=asset, url_scheme=self._url_scheme, root_path=self._root_path+'data/',
                    store_metrics=[('SMA', (200,)), ('SMA', (50,)), ('EMA', (50,)), ('WMA', (50,)), ('HMA', (50,))],
                    store_signals=[('CROSSOVERS', ('SMA_50', 'SMA_200')), ('TREND', ('SMA_50',)), ('PRICECROSS', ('SMA_50',))],
  ...
  def update_info(self):
    ...
    columns = ['symbol', 'base', 'quote', 'status', 'minPrice', 'maxPrice', 'tickSize', 'minQty', 'maxQty', 'stepSize']
